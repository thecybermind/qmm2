...
intptr_t SIN_GameSupport::syscall(intptr_t cmd, ...) {
    ...
    switch (cmd) {
        ...
        ROUTE_IMPORT_9_V(sound, G_SOUND, edict_t*, int, int, FLOAT_CAST, FLOAT_CAST, FLOAT_CAST, FLOAT_CAST, FLOAT_CAST, int);
        ROUTE_IMPORT_10_V(positioned_sound, G_POSITIONED_SOUND, float*, edict_t*, int, int, FLOAT_CAST, FLOAT_CAST, FLOAT_CAST, FLOAT_CAST, FLOAT_CAST, int);
        ...
        ROUTE_IMPORT_8(fulltrace, G_FULLTRACE, trace_t*, float*, float*, float*, float*, FLOAT_CAST, edict_t*, int);
        ...
        ROUTE_IMPORT_4(Alias_Add, G_ALIAS_ADD, int, const char*, const char*, FLOAT_CAST);
        ...
        ROUTE_IMPORT_3(GlobalAlias_Add, G_GLOBALALIAS_ADD, const char*, const char*, FLOAT_CAST);
...
game_import_t SIN_GameSupport::qmm_import = {
    ...
    GEN_IMPORT_2_F(Group_DamageMultiplier, G_GROUP_DAMAGEMULTIPLIER, int, int),
