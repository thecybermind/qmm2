...
intptr_t MOHSH_GameSupport::syscall_args(intptr_t cmd, intptr_t* args) {
    if (cmd != G_PRINT)
...
intptr_t MOHSH_GameSupport::vmMain_args(intptr_t cmd, intptr_t* args) {
...
bool MOHSH_GameSupport::ModLoad(void* entry, APIType mod_api) {
...
void MOHSH_GameSupport::ModUnload(APIType) {
    orig_export = nullptr;
}
