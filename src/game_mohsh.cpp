...
static game_import_t qmm_import = {
	...
	GEN_IMPORT(MSG_WriteFloat, G_MSG_WRITEFLOAT),
	GEN_IMPORT(MSG_WriteString, G_MSG_WRITESTRING),
	GEN_IMPORT(MSG_WriteAngle8, G_MSG_WRITEANGLE8),
	GEN_IMPORT(MSG_WriteAngle16, G_MSG_WRITEANGLE16),
	GEN_IMPORT(MSG_WriteCoord, G_MSG_WRITECOORD),
	...
	GEN_IMPORT(TIKI_CalculateBounds, G_TIKI_CALCULATEBOUNDS),
	...
	GEN_IMPORT(TIKI_IsOnGroundInternal, G_TIKI_ISONGROUNDINTERNAL),
	GEN_IMPORT(TIKI_SetPoseInternal, G_TIKI_SETPOSEINTERNAL),
	...
	GEN_IMPORT(HudDrawAlpha, G_HUDDRAWALPHA),
...
typedef intptr_t (*pfn_import_t)(intptr_t arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6);
...
intptr_t MOHSH_syscall(int cmd, ...) {
	QMM_GET_SYSCALL_ARGS();

	if (cmd != G_PRINT)
		LOG(TRACE, "QMM") << fmt::format("MOHSH_syscall({}) called\n", MOHSH_eng_msg_names(cmd));
	...
	if (cmd != G_PRINT)
		LOG(TRACE, "QMM") << fmt::format("MOHSH_syscall({}) returning {}\n", MOHSH_eng_msg_names(cmd), ret);
...
typedef intptr_t (*pfn_export_t)(intptr_t arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6, intptr_t arg7, intptr_t arg8);
...
void* MOHSH_GetGameAPI(void* import) {
	LOG(TRACE, "QMM") << fmt::format("MOHSH_GetGameAPI({}) called\n", import);
	...
	LOG(TRACE, "QMM") << fmt::format("MOHSH_GetGameAPI({}) returning {}\n", import, (void*)&qmm_export);
