...
static game_import_t qmm_import = {
	...
	/* CM_VisualObfuscation */ +[](const vec3_t arg0, const vec3_t arg1) -> float { return ((float(*)(intptr_t, ...))syscall)(G_CM_VISUALOBFUSCATION, arg0, arg1); },
	...
	/* Anim_Time */ +[](dtiki_t* arg0, int arg1) -> float { return ((float(*)(intptr_t, ...))syscall)(G_ANIM_TIME, arg0, arg1); },
	/* Anim_Frametime */ +[](dtiki_t* arg0, int arg1) -> float { return ((float(*)(intptr_t, ...))syscall)(G_ANIM_FRAMETIME, arg0, arg1); },
	/* Anim_CrossTime */ +[](dtiki_t* arg0, int arg1) -> float { return ((float(*)(intptr_t, ...))syscall)(G_ANIM_CROSSTIME, arg0, arg1); },
	...
	/* TIKI_OrientationInternal */ +[](dtiki_t* arg0, int arg1, int arg2, float arg3) -> orientation_t { return ((orientation_t(*)(intptr_t, ...))syscall)(G_TIKI_ORIENTATIONINTERNAL, arg0, arg1, arg2, *(intptr_t*)&arg3); },
	...
	/* SoundLength */ +[](int arg0, const char* arg1) -> float { return ((float(*)(intptr_t, ...))syscall)(G_SOUNDLENGTH, arg0, arg1); },
