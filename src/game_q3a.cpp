...
intptr_t Q3A_GameSupport::syscall_args(intptr_t cmd, intptr_t* args) {
    if (cmd != G_PRINT)
...
intptr_t Q3A_GameSupport::vmMain_args(intptr_t cmd, intptr_t* args) {
...
void Q3A_GameSupport::ModUnload(APIType) {
    orig_vmMain = nullptr;
}
