...
static game_import_t qmm_import = {
	...
	GEN_IMPORT_2(G_SETDYNAMICLIGHT, void, int, float),
	GEN_IMPORT_2(G_SETDYNAMICLIGHTDEFAULT, void, int, float),
	GEN_IMPORT(SetWindDirection, G_SETWINDDIRECTION),
	GEN_IMPORT_1(G_SETWINDINTENSITY, void, float),
	GEN_IMPORT(SetWeatherInfo, G_SETWEATHERINFO),
	GEN_IMPORT_1(G_SETTIMESCALE, void, float),
	...
	GEN_IMPORT_4(G_CALCULATEBOUNDS, void, int, float, vec3_t, vec3_t),
	...
	GEN_IMPORT_6(G_FRAME_BOUNDS, void, int, int, int, float, vec3_t, vec3_t),
	...
	/* AAS_Time */ +[]() -> float { return ((float(*)(intptr_t))syscall)(G_SOUNDLENGTH); },
	...
	GEN_IMPORT_13(G_AAS_PREDICTCLIENTMOVEMENT, int, struct aas_clientmove_s*, int, vec3_t, int, int, vec3_t, vec3_t, int, int, float, int, int, int),
	...
	GEN_IMPORT_3(G_EA_MOVE, void, int, vec3_t, float),
	GEN_IMPORT(EA_View, G_EA_VIEW),
	GEN_IMPORT_2(G_EA_ENDREGULAR, void, int, float),
	GEN_IMPORT_3(G_EA_GETINPUT, void, int, float, bot_input_t*),
	GEN_IMPORT(EA_ResetInput, G_EA_RESETINPUT),
	GEN_IMPORT_2(G_BOTLOADCHARACTER, int, char*, float),
	...
	GEN_IMPORT_6(G_BOTCHOOSENBGITEM, int, int, vec3_t, int*, int, struct bot_goal_s*, float),
	...
	GEN_IMPORT_3(G_BOTSETAVOIDGOALTIME, void, int, int, float),
	...
	GEN_IMPORT_2(G_BOTMUTATEGOALFUZZYLOGIC, void, int, float),
	...
	GEN_IMPORT_4(G_BOTMOVEINDIRECTION, int, int, vec3_t, float, int),
	...
	GEN_IMPORT_5(G_BOTMOVEMENTVIEWTARGET, int, int, struct bot_goal_s*, int, float, vec3_t),
	...
	GEN_IMPORT_4(G_BOTADDAVOIDSPOT, void, int, vec3_t, float, int),
	...
	GEN_IMPORT_1(G_BOTLIBSTARTFRAME, int, float),
