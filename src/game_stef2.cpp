...
static game_import_t qmm_import = {
	...
	GEN_IMPORT(SetDynamicLight, G_SETDYNAMICLIGHT),
	GEN_IMPORT(SetDynamicLightDefault, G_SETDYNAMICLIGHTDEFAULT),
	GEN_IMPORT(SetWindDirection, G_SETWINDDIRECTION),
	GEN_IMPORT(SetWindIntensity, G_SETWINDINTENSITY),
	GEN_IMPORT(SetWeatherInfo, G_SETWEATHERINFO),
	GEN_IMPORT(SetTimeScale, G_SETTIMESCALE),
	...
	GEN_IMPORT(CalculateBounds, G_CALCULATEBOUNDS),
	...
	GEN_IMPORT(Frame_Bounds, G_FRAME_BOUNDS),
	...
	GEN_IMPORT(Tag_OrientationEx, G_TAG_ORIENTATIONEX),
	...
	GEN_IMPORT(EA_Move, G_EA_MOVE),
	GEN_IMPORT(EA_View, G_EA_VIEW),
	GEN_IMPORT(EA_EndRegular, G_EA_ENDREGULAR),
	GEN_IMPORT(EA_GetInput, G_EA_GETINPUT),
	GEN_IMPORT(EA_ResetInput, G_EA_RESETINPUT),
	GEN_IMPORT(BotLoadCharacter, G_BOTLOADCHARACTER),
	...
	GEN_IMPORT(BotChooseNBGItem, G_BOTCHOOSENBGITEM),
	...
	GEN_IMPORT(BotSetAvoidGoalTime, G_BOTSETAVOIDGOALTIME),
	...
	GEN_IMPORT(BotMutateGoalFuzzyLogic, G_BOTMUTATEGOALFUZZYLOGIC),
	...
	GEN_IMPORT(BotMoveInDirection, G_BOTMOVEINDIRECTION),
	...
	GEN_IMPORT(BotMovementViewTarget, G_BOTMOVEMENTVIEWTARGET),
	...
	GEN_IMPORT(BotAddAvoidSpot, G_BOTADDAVOIDSPOT),
	...
	GEN_IMPORT(BotLibStartFrame, G_BOTLIBSTARTFRAME),
