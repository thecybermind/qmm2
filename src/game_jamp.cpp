...
struct JAMP_GameSupport : public GameSupport {
    ...
    virtual const char* GameName() { return "Jedi Knight: Jedi Academy (MP)"; }
    virtual const char* GameCode() { return "JAMP"; }
...
const char* JAMP_GameSupport::EngMsgName(intptr_t cmd) {
    switch (cmd) {
        GEN_CASE(G_PRINT);
        GEN_CASE(G_ERROR);
...
const char* JAMP_GameSupport::ModMsgName(intptr_t cmd) {
    switch (cmd) {
        GEN_CASE(GAME_INIT);
...
intptr_t JAMP_GameSupport::orig_apiversion = 0;


game_import_t JAMP_GameSupport::orig_import = {};


game_export_t* JAMP_GameSupport::orig_export = nullptr;


game_import_t JAMP_GameSupport::qmm_import = {
...
game_export_t JAMP_GameSupport::qmm_export = {
