...
#ifdef _DEBUG
    if (cmd != G_PRINT)
        LOG(QMM_LOG_DEBUG, "QMM") << fmt::format("STVOYSP_GameSupport::syscall({} {}) called\n", EngMsgName(cmd), cmd);
#endif
...
#ifdef _DEBUG
    if (cmd != G_PRINT)
        LOG(QMM_LOG_DEBUG, "QMM") << fmt::format("STVOYSP_GameSupport::syscall({} {}) returning {}\n", EngMsgName(cmd), cmd, ret);
#endif
...
#ifdef _DEBUG
    LOG(QMM_LOG_DEBUG, "QMM") << fmt::format("STVOYSP_GameSupport::vmMain({} {}) called\n", ModMsgName(cmd), cmd);
#endif
...
#ifdef _DEBUG
    LOG(QMM_LOG_DEBUG, "QMM") << fmt::format("STVOYSP_GameSupport::vmMain({} {}) returning {}\n", ModMsgName(cmd), cmd, ret);
#endif
...
void* STVOYSP_GameSupport::Entry(void* import, void*, APIType) {
    LOG(QMM_LOG_DEBUG, "QMM") << fmt::format("STVOYSP_GameSupport::Entry({}) called\n", import);
    ...
    LOG(QMM_LOG_DEBUG, "QMM") << fmt::format("STVOYSP_GameSupport::Entry({}) returning {}\n", import, fmt::ptr(&qmm_export));
