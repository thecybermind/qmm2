...
/*
#if defined(_WIN32)
	{ "game" MOD_DLL,	    nullptr,			".",			"Call of Duty (SP)",							{ "cod" },              GEN_INFO(CODSP),	GEN_DLL(CODSP),		-1,		-1 },
	{ "uo_game" MOD_DLL,    nullptr,			".",			"Call of Duty: United Offensive (SP)",			{ "coduo" },            GEN_INFO(CODUOSP),	GEN_DLL(CODUOSP),	-1,		-1 },
#endif
*/
