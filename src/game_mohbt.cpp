...
intptr_t MOHBT_GameSupport::syscall_args(intptr_t cmd, intptr_t* args) {
    if (cmd != G_PRINT)
        QMMLOG(QMM_LOG_TRACE, "QMM") << "MOHBT_GameSupport::syscall(" << EngMsgName(cmd) << "(" << cmd << ")) called\n";
    ...
    if (cmd != G_PRINT)
        QMMLOG(QMM_LOG_TRACE, "QMM") << "MOHBT_GameSupport::syscall(" << EngMsgName(cmd) << "(" << cmd << ")) reutrning " << ret << "\n";
...
intptr_t MOHBT_GameSupport::vmMain_args(intptr_t cmd, intptr_t* args) {
    QMMLOG(QMM_LOG_TRACE, "QMM") << "MOHBT_GameSupport::vmMain(" << ModMsgName(cmd) << "(" << cmd << ")) called\n";
    ...
    QMMLOG(QMM_LOG_TRACE, "QMM") << "MOHBT_GameSupport::vmMain(" << ModMsgName(cmd) << "(" << cmd << ")) returning " << ret << "\n";
...
void* MOHBT_GameSupport::Entry(void* import, void*, APIType) {
    QMMLOG(QMM_LOG_DEBUG, "QMM") << "MOHBT_GameSupport::Entry(" << import << ") called\n";
    ...
    QMMLOG(QMM_LOG_DEBUG, "QMM") << "MOHBT_GameSupport::Entry(" << import << ") returning " << &qmm_export << "\n";
...
void MOHBT_GameSupport::SpawnEntities(char* entstring, int levelTime) {
    ...
    intptr_t args[] = { (intptr_t)entstring, levelTime };
