...
static game_import_t qmm_import = {
	...
	/* CM_VisualObfuscation */ +[](const vec3_t arg0, const vec3_t arg1) -> float { return ((float(*)(intptr_t, const vec3_t, const vec3_t))syscall)(G_CM_VISUALOBFUSCATION, arg0, arg1); },
	...
	/* Anim_Time */ +[](dtiki_t* arg0, int arg1) -> float { return ((float(*)(intptr_t, dtiki_t*, int))syscall)(G_ANIM_TIME, arg0, arg1); },
	/* Anim_Frametime */ +[](dtiki_t* arg0, int arg1) -> float { return ((float(*)(intptr_t, dtiki_t*, int))syscall)(G_ANIM_FRAMETIME, arg0, arg1); },
	/* Anim_CrossTime */ +[](dtiki_t* arg0, int arg1) -> float { return ((float(*)(intptr_t, dtiki_t*, int))syscall)(G_ANIM_CROSSTIME, arg0, arg1); },
...
static game_export_t qmm_export = {
	...
	/* TIKI_Orientation */ +[](gentity_t* arg0, int arg1) -> orientation_t { return ((orientation_t(*)(intptr_t, gentity_t*, int))vmMain)(GAME_TIKI_ORIENTATION, arg0, arg1); },
	/* DebugCircle */ +[](float* arg0, float arg1, float arg2, float arg3, float arg4, float arg5, qboolean arg6) -> void { vmMain(GAME_DEBUG_CIRCLE, arg0, *(intptr_t*)&arg1, *(intptr_t*)&arg2, *(intptr_t*)&arg3, *(intptr_t*)&arg4, *(intptr_t*)&arg5, arg6); },
...
intptr_t MOHBT_vmMain(intptr_t cmd, ...) {
	...
	LOG(QMM_LOG_TRACE, "QMM") << fmt::format("MOHBT_vmMain({}) returning {}\n", MOHBT_mod_msg_names(cmd), ret);
