...
static const char* MOHBT_EngMsgName(intptr_t cmd) {
    switch (cmd) {
        GEN_CASE(G_PRINTF);
        GEN_CASE(G_DPRINTF);
        GEN_CASE(G_DPRINTF2);
...
static const char* MOHBT_ModMsgName(intptr_t cmd) {
    switch (cmd) {
